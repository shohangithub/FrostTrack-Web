...
public class SalesService : ISalesService
{
    ...
    public async Task<PaginationResult<SalesListResponse>> PaginationListAsync(SalesPaginationQuery requestQuery, CancellationToken cancellationToken = default)
    {
