...
{
    /// <inheritdoc />
    public partial class RemoveBookingLedgersAndUpdateStorageCharge : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("UPDATE finance.TransactionHeads SET Type = 'CREDIT' WHERE UsageFor = 'STORAGE_CHARGE';");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringChargeEntries_TenantId",
                schema: "product",
        ...
        {
            migrationBuilder.Sql("UPDATE finance.TransactionHeads SET Type = 'DEBIT' WHERE UsageFor = 'STORAGE_CHARGE';");
