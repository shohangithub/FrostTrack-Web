...
namespace Persistence.Migrations
{
    ...
    [Migration("20260924133855_AddTotalDueAndCurrentDueToTransaction")]
    partial class AddTotalDueAndCurrentDueToTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entitites.Branch", b =>
                {
                    ...
                    b.Property<bool>("AutoGenerateBookingNo")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entitites.Company", b =>
                {
                    ...
                    b.Property<bool>("EnableRecurringChargeJob")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entitites.DeliveryChallan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("DeliveryChallan", "product");
                });

            modelBuilder.Entity("Domain.Entitites.DeliveryChallanItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("DeliveryChallanItem", "product");
                });
            ...
            modelBuilder.Entity("Domain.Entitites.PrintSettings", b =>
                {
                    ...
                    b.Property<string>("PaymentReceiptTitle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("ShowAmountSummary")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowBranchInfo")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entitites.SeasonArchiveLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("TotalArchivedBookings")
                        .HasColumnType("int");

                    b.Property<int>("TotalArchivedChallans")
                        .HasColumnType("int");

                    b.Property<int>("TotalArchivedDeliveries")
                        .HasColumnType("int");

                    b.Property<int>("TotalArchivedTransactions")
                        .HasColumnType("int");

                    b.Property<decimal>("TotalCarriedForwardBankBalance")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("TotalCarriedForwardBookings")
                        .HasColumnType("int");

                    b.Property<decimal>("TotalCarriedForwardCashBalance")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalCarriedForwardCustomerDue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalCarriedForwardStock")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("SeasonArchiveLogs", "operations");
                });
            ...
            modelBuilder.Entity("Domain.Entitites.Transaction", b =>
                {
                    ...
                    b.Property<Guid>("TransactionHeadId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TransactionHeadId");

                    b.ToTable("Transactions", "finance");
                });

            modelBuilder.Entity("Domain.Entitites.TransactionHead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("TransactionHeads", "finance");
                });
            ...
            modelBuilder.Entity("Domain.Entitites.DeliveryChallanItem", b =>
                {
                    b.HasOne("Domain.Entitites.DeliveryChallan", "DeliveryChallan")
                        .WithMany("ChallanItems")
            ...
            modelBuilder.Entity("Domain.Entitites.SalaryPayment", b =>
                {
                    ...
                    b.HasOne("Domain.Entitites.Transaction", "Transaction")
                        ...
                        .HasForeignKey("Domain.Entitites.SalaryPayment", "TransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
