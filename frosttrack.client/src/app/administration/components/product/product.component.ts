      ...
      if (response?.success) {
        ...
        this.data = this.data.filter((value, key) => {
          if (value.id == result.id) {
            ...
            value.isRawMaterial = result.isRawMaterial;
            value.isFinishedGoods = result.isFinishedGoods;
            value.reOrederLevel = result.reOrederLevel;
            value.purchaseRate = result.purchaseRate;
            value.sellingRate = result.sellingRate;
            value.wholesalePrice = result.wholesalePrice;
            value.vatPercent = result.vatPercent;
            value.isProductAsService = result.isProductAsService;
            value.productAs = result.isProductAsService ? 'Service' : 'Product';
