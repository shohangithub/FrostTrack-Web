...
@Component({
  selector: 'app-bill-collection-receipt-print',
  templateUrl: './bill-collection-receipt-print.component.html',
  styleUrls: ['./bill-collection-receipt-print.component.scss'],
  standalone: true,
