export class MessageHub {
  public static ADD = 'Add Record Successfully';
  public static UPDATE = 'Edit Record Successfully';
  public static DELETE_CONFIRM = 'Are you sure? Want to delete this record?';
