...
export class CompanyConfigComponent implements OnInit {
  ...
  initFormData() {
    this.register = this.fb.group({
      ...
      autoGenerateBookingNo: [false],
      enableRecurringChargeJob: [false],
    ...
    this.companyService.getById(this.row.id).subscribe({
      next: (response: ICompanyResponse) => {
        this.register.patchValue({
          ...
          autoGenerateBookingNo: response.autoGenerateBookingNo,
          enableRecurringChargeJob: response.enableRecurringChargeJob ?? false,
          enableEmailNotifications: response.enableEmailNotifications ?? false,
  ...
  onSubmit() {
    if (this.register.valid) {
      ...
      const payload: ICompanyRequest = {
        ...
        autoGenerateBookingNo: this.register.value.autoGenerateBookingNo,
        enableRecurringChargeJob: this.register.value.enableRecurringChargeJob ?? false,
        enableEmailNotifications: this.register.value.enableEmailNotifications ?? false,
